...
public class HolaMundo {
    public static void main(String[] args) {
        ...
        var numFloatVar = 10.0F; //Automaticamente con el punto y F se transforma en tipo float
        System.out.println("numFloat = " + numFloatVar);
        var numDoubleVar = 10.0;
        System.out.println("numDouble = " + numDoubleVar);
